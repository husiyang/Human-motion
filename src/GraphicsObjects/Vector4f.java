...
public class Vector4f {
	...
	{ 
		return new Point4f(this.x + Additonal.getPostion(0), this.y + Additonal.getPostion(1),this.z + Additonal.getPostion(2),this.a + Additonal.getPostion(3));
	} 
	...
	{
		return new Vector4f((-1)*this.x,(-1)*this.y,(-1)*this.z,(-1)*this.a );
	}
